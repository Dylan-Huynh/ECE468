...
class MicroCListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by MicroCParser#true_type.
    def enterTrue_type(self, ctx:MicroCParser.True_typeContext):
        pass

    # Exit a parse tree produced by MicroCParser#true_type.
    def exitTrue_type(self, ctx:MicroCParser.True_typeContext):
        pass
